<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="GenerateCSVReport.aspx.cs" Inherits="CashLoanShop.Admin.GenerateCSVReport" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.download').click(function () {
                //alert($(this).data("id"));
                window.open('/Admin/DownloadReport.aspx?Id=' + $(this).data("id") + '&fromDate=' + $('#' + '<%= txtFromDate.ClientID %>').val() + '&ToDate=' + $('#' + '<%= txtToDate.ClientID %>').val(), '_self', 'width=1200,height=750,location=no,left=200px');
        });
        });
