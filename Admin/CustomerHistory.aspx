<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="CustomerHistory.aspx.cs" Inherits="CashLoanShop.Admin.CustomerHistory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script>
         ...
         function openhistory(obj) {
             window.open('/CustomerCashHistory.aspx?Id=' + obj + '&IsCurrencyExchange=true&IsLoan=true&IsTermLoan=true&Mode=Admin', '_blank', 'width=1400,height=750,location=no,left=200px');
         }
    </script>
</asp:Content>
