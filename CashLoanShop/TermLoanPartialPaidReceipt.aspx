<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TermLoanPartialPaidReceipt.aspx.cs" Inherits="CashLoanShop.TermLoanPartialPaidReceipt" %>
        ...
        <div id="printarea">
            ...
            <div style="width: 70%; font-size: 15px;">
                <table style="width: 60%;">
                    ...
                    <tr>
                        <td style="border:1px solid black;">Interest Charge:
                        </td>
                        <td style="border:1px solid black;">
