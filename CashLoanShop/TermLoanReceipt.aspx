<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TermLoanReceipt.aspx.cs" Inherits="CashLoanShop.TermLoanReceipt" %>
            ...
            <div style="width: 100%; font-size: 15px;">
                <table style="width: 50%;">
                    <tr>
                        ...
                        <td style="width: 60%;">
                            <asp:Label ID="lblTransactionType" runat="server" Text="Term Loan" Style="font-weight: bold;"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>Receipt Number:
                ...
                <table style="width: 60%;">
                    ...
                    <tr>
                       ...
                       <tr>
                        ...
                        <td>
                            <asp:Label ID="lblInterestCharge" runat="server" Style="font-weight: bold;"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>Due Amount:
