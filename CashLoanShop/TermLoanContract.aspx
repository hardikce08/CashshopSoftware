<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TermLoanContract.aspx.cs" Inherits="CashLoanShop.TermLoanContract" %>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#btnreturn").click(function () {
            window.location.href = "/TermLoanReceipt.aspx?Id=" + $('#hdnLoanId').val();
        });
    });
</script>
