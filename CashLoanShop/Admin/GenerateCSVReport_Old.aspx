<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="GenerateCSVReport_Old.aspx.cs" Inherits="CashLoanShop.Admin.GenerateCSVReport_Old" %>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <table style="width: 60%;">
                            <tr>
                                <td>
                                    <asp:GridView Width="100%" ID="dgvCustomer" CssClass="EU_DataTable" AllowPaging="true" PageSize="15" class="table table-hover table-bordered" AutoGenerateColumns="false" runat="server">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.download').click(function () {
                //alert($(this).data("id"));
                window.open('/Admin/DownloadReport_old.aspx?Id=' + $(this).data("id") + '&Date=' + $('#' + '<%= txtDate.ClientID %>').val(), '_self', 'width=1200,height=750,location=no,left=200px');
        });
        });
